...
export default function App() {
  ...
  return <AppContext.Provider value={{ wallet, connect, launchStory: () => setStoryOpen(true) }}><AppErrorBoundary>
    <Routes><Route path="/" element={<HomeLayout />} /><Route element={<AppShell />}><Route path="/dashboard" element={<DashboardPage />} /><Route path="/missions" element={<MissionsPage />} /><Route path="/vault" element={<VaultPage />} /><Route path="/dispatch" element={<DispatchPage />} /><Route path="/how-it-works" element={<HowItWorksPage />} /><Route path="/settings" element={<SettingsPage />} /><Route path="/game" element={<GamePage />} /><Route path="/game/story" element={<GameStoryPage />} /><Route path="/game/map" element={<GameMapPage />} /><Route path="/game/quests" element={<SideQuestsPage />} /><Route path="/game/quest/:questId" element={<QuestArcadePage />} /><Route path="/game/garage" element={<GaragePage />} /><Route path="/game/leaderboard" element={<LeaderboardPage />} /><Route path="/story/manga" element={<StoryMangaPage />} /></Route><Route path="/start" element={<Navigate to="/" replace />} /><Route path="*" element={<NotFoundPage />} /></Routes>
